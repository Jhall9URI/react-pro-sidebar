...
var MenuItem = function (_a, ref) {
    var children = _a.children, className = _a.className, icon = _a.icon, active = _a.active, prefix = _a.prefix, suffix = _a.suffix; _a.firstchild; _a.popperarrow; var clickHandler = _a.clickHandler, rest = __rest(_a, ["children", "className", "icon", "active", "prefix", "suffix", "firstchild", "popperarrow", "clickHandler"]);
    ...
    return (React__default['default'].createElement("li", __assign({ ref: menuItemRef, className: classnames('pro-menu-item', className, { active: active }) }, rest),
        React__default['default'].createElement("div", { className: "pro-inner-item", tabIndex: 0, role: "button", onClick: typeof clickHandler === 'undefined' ? null : clickHandler },
...
var SubMenu = function (_a, ref) {
    var children = _a.children, icon = _a.icon, className = _a.className, title = _a.title, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b, open = _a.open, prefix = _a.prefix, suffix = _a.suffix, firstchild = _a.firstchild, popperarrow = _a.popperarrow, onOpenChange = _a.onOpenChange, clickHandler = _a.clickHandler, rest = __rest(_a, ["children", "icon", "className", "title", "defaultOpen", "open", "prefix", "suffix", "firstchild", "popperarrow", "onOpenChange", "clickHandler"]);
    var popperInstance;
    ...
    return (React__default['default'].createElement("li", __assign({ ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        React__default['default'].createElement("div", { ref: referenceElement, className: "pro-inner-item", onClick: typeof clickHandler === 'undefined' ? handleToggleSubMenu : clickHandler, onKeyPress: handleToggleSubMenu, role: "button", tabIndex: 0 },
            icon ? (React__default['default'].createElement("span", { className: "pro-icon-wrapper" },
                React__default['default'].createElement("span", { className: "pro-icon" }, icon))) : null,
            prefix ? React__default['default'].createElement("span", { className: "prefix-wrapper" }, prefix) : null,
        ...
        firstchild && collapsed ? (React__default['default'].createElement("div", { ref: popperElement, className: classnames('pro-inner-list-item popper-element', { 'has-arrow': popperarrow }) },
            React__default['default'].createElement("div", { className: "popper-inner", ref: popperElRef },
                React__default['default'].createElement("ul", null, children)),
            popperarrow ? React__default['default'].createElement("div", { className: "popper-arrow", "data-popper-arrow": true }) : null)) : (React__default['default'].createElement(SlideDown, { closed: typeof open === 'undefined' ? closed : !open, className: "pro-inner-list-item" },
